...
const (
	Push_PushCodeToStudent_FullMethodName = "/Push.Push/PushCodeToStudent"
)
...
type PushClient interface {
	// 推送一条带 code 的消息给某个群组
	PushCodeToStudent(ctx context.Context, in *PushCodeReq, opts ...grpc.CallOption) (*PushReply, error)
}
...
func (c *pushClient) PushCodeToStudent(ctx context.Context, in *PushCodeReq, opts ...grpc.CallOption) (*PushReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PushReply)
	err := c.cc.Invoke(ctx, Push_PushCodeToStudent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPushServer) PushCodeToStudent(context.Context, *PushCodeReq) (*PushReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PushCodeToStudent not implemented")
}
...
func _Push_PushCodeToStudent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PushCodeReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PushServer).PushCodeToStudent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Push_PushCodeToStudent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PushServer).PushCodeToStudent(ctx, req.(*PushCodeReq))
	}
...
var Push_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PushCodeToStudent",
			Handler:    _Push_PushCodeToStudent_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/push/v1/push.proto",
}
