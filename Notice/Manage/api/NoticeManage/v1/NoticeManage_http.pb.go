...
const OperationTeaManageCallbackReceipt = "/NoticeManage.TeaManage/CallbackReceipt"
const OperationTeaManageConfirmNotice = "/NoticeManage.TeaManage/ConfirmNotice"
const OperationTeaManageDeleteNotice = "/NoticeManage.TeaManage/DeleteNotice"
const OperationTeaManagePublishNotice = "/NoticeManage.TeaManage/PublishNotice"
const OperationTeaManageRemindNotice = "/NoticeManage.TeaManage/RemindNotice"
...
func RegisterTeaManageHTTPServer(s *http.Server, srv TeaManageHTTPServer) {
	...
	r.POST("/student/notice/confirm", _TeaManage_ConfirmNotice0_HTTP_Handler(srv))
}
...
func _TeaManage_ConfirmNotice0_HTTP_Handler(srv TeaManageHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationTeaManageConfirmNotice)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *TeaManageHTTPClientImpl) ConfirmNotice(ctx context.Context, in *ConfirmNoticeReq, opts ...http.CallOption) (*ConfirmNoticeResp, error) {
	var out ConfirmNoticeResp
	pattern := "/student/notice/confirm"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationTeaManageConfirmNotice))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
