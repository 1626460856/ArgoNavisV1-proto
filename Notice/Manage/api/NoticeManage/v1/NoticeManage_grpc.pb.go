...
const (
	TeaManage_CallbackReceipt_FullMethodName = "/NoticeManage.TeaManage/CallbackReceipt"
	TeaManage_RemindNotice_FullMethodName    = "/NoticeManage.TeaManage/RemindNotice"
	TeaManage_DeleteNotice_FullMethodName    = "/NoticeManage.TeaManage/DeleteNotice"
	TeaManage_PublishNotice_FullMethodName   = "/NoticeManage.TeaManage/PublishNotice"
	TeaManage_ConfirmNotice_FullMethodName   = "/NoticeManage.TeaManage/ConfirmNotice"
)
...
func (c *teaManageClient) ConfirmNotice(ctx context.Context, in *ConfirmNoticeReq, opts ...grpc.CallOption) (*ConfirmNoticeResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConfirmNoticeResp)
	err := c.cc.Invoke(ctx, TeaManage_ConfirmNotice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTeaManageServer) ConfirmNotice(context.Context, *ConfirmNoticeReq) (*ConfirmNoticeResp, error) {
...
func _TeaManage_ConfirmNotice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConfirmNoticeReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TeaManageServer).ConfirmNotice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TeaManage_ConfirmNotice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TeaManageServer).ConfirmNotice(ctx, req.(*ConfirmNoticeReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TeaManage_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "NoticeManage.TeaManage",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TeaManage_ConfirmNotice_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/NoticeManage/v1/NoticeManage.proto",
}
